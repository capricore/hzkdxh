...
subMenu.style.display = "none";
	...
	<h1 style="padding-bottom:2px">
		...
		<ul id="navigation">            
                     ...
                     <li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"><a><span>关于协会</span></a>
                         <ul>
					 ...
					 <li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"><a><span>行业公告</span></a>
					   <ul>
					 ...
					 <li onmouseover="displaySubMenu(this)" onmouseout="hideSubMenu(this)"><a href="/hzkdxh/news/newsList.do?newstype=4&subtype=1&start=1"><span>会员风采</span></a></li>
