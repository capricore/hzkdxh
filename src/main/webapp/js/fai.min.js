...
Fai.popupWindow = function(g) {
    ...
    var f = "<iframe " + i + ' id="popupWindowIframe' + s + '" class="popupWindowIframe" src="" frameborder="0" scrolling="' + x.frameScrolling + '" style="width:100%;height:100%;"></iframe>';
    var u = true;
    if (x.divId != null) {
        u = false;
        f = $(x.divId).html()
    ...
    if (u) {
        Fai.top.$("#waitingP" + s).height(Fai.top.$("#formBC" + s).height());
        Fai.top.$("#waitingP" + s).width(Fai.top.$("#formBC" + s).width())
    } else {
...
Fai.closePopupWindow = function(g, d) {
    if (g) {
        try {
            if (Fai.isNull(Fai.top._popupOptions["popup" + g])) {
                return
            }
            var c = Fai.top._popupOptions["popup" + g];
            if (c.change) {
            ...
            if (!Fai.isNull(b.closeFunc)) {
                if (d) {
                    ...
                    b.closeFunc(Fai.top._popupOptions["popup" + g].closeArgs)
                }
            }
            Fai.top._popupOptions["popup" + g] = {};
            var a = Fai.top.$("#popupWindow" + g);
            if (b.animate) {
                Fai.top.Fai.closePopupWindowAnimate(a, b.animateTarget, b.animateOnClose)
            }
            Fai.top.setTimeout("Fai.closePopupWindow_Internal('" + g + "')")
        } catch(f) {}
    } else {
        Fai.removeBg();
