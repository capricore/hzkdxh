...
(function(b, e) {
    ...
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseStart: function(g, h, d) {
            ...
            this.originalPageY = g.pageY; (j.cursorAt && this._adjustOffsetFromHelper(j.cursorAt));
            this.domPosition = {
        ...
        _refreshItems: function(d) {
            ...
            var l = this.items;
            var r = this;
            var h = [[b.isFunction(this.options.items) ? this.options.items.call(this.element[0], d, {
                item: this.currentItem
        ...
        drag: function(v, q) {
            ...
            for (var w = h.snapElements.length - 1; w >= 0; w--) {
                ...
                if (! ((u - z < y && y < p + z && n - z < g && g < B + z) || (u - z < y && y < p + z && n - z < f && f < B + z) || (u - z < x && x < p + z && n - z < g && g < B + z) || (u - z < x && x < p + z && n - z < f && f < B + z))) {
                    if (h.snapElements[w].snapping) { (h.options.snap.release && h.options.snap.release.call(h.element, v, b.extend(h._uiHash(), {
                ...
                if (!h.snapElements[w].snapping && (e || A || k || m || j)) { (h.options.snap.snap && h.options.snap.snap.call(h.element, v, b.extend(h._uiHash(), {
                        snapItem: h.snapElements[w].item
                    })))
                }
...
(function(b, c) {
    ...
    d.widget("ui.resizable", d.ui.mouse, {
        ...
        _propagate: function(g, f) {
            d.ui.plugin.call(this, g, [f, this.ui()]); (g != "resize" && this._trigger(g, f, this.ui()))
        },
        plugins: {},
        ui: function() {
            return {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _getInst: function(target) {
            try {
                if (($.browser.msie && "9.0" === $.browser.version) || ($.browser.msie && "10.0" === $.browser.version) || ($.browser.msie && "11.0" === $.browser.version)) {
...
jQuery(function(b) {
    ...
    b.widget("ui.droppable", {
        ...
        _create: function() {
            ...
            b.ui.ddmanager.droppables[e.scope].push(this); (e.addClasses && this.element.addClass("ui-droppable"))
        },
        destroy: function() {
    ...
    e.widget("ui.tabs", {
        ...
        _tabify: function(u) {
            ...
            if (u) {
                ...
                k.disabled = e.unique(k.disabled.concat(e.map(this.lis.filter(".ui-state-disabled"),
                function(w, o) {
            ...
            function(i, o) {
                ...
                o.hide().removeClass("ui-tabs-hide").animate(p, p.duration || "normal",
                function() {
                    l(o, p);
            ...
            this.anchors.bind(k.event + ".tabs",
            function() {
                var o = this,
                x = e(o).closest("li"),
        ...
        remove: function(h) {
            ...
            j.disabled = e.map(e.grep(j.disabled,
            function(m, l) {
                return m != h
            }),
            function(m, l) {
    ...
    e.extend(e.ui.tabs.prototype, {
        ...
        rotate: function(j, l) {
            ...
            var k = h._unrotate || (h._unrotate = !l ?
            function(n) {
                if (n.clientX) {
                    h.rotate(null)
                }
...
(function(b) {
        ...
        function k(t, s) {
            ...
            if (d(t)) {
                setTimeout(function() {
                    ...
                    ((w + v) * r.scrollSpeed), r.fxEasingScroll,
                    function() {
                        j(t)
                    })
                },
    ...
    jQuery.fn.extend({
        imageSwitch: function(d) {
            ...
            return b(this).each(function() {
                ...
                var s = b('<div class="imageSwitchShowName photoSwitchBg" />').appendTo(A).css("position", "absolute").css("display", "none").css("zIndex", 2).css("width", b.browser.msie && b.browser.version == 6 ? b(A).parent().parent().width() + "px": b(A).parent().width() + "px").css("height", 30 + "px").css("line-height", 30 + "px");
                if (J == 0) {
                ...
                if (c.btnType != 0) {
                    var C = b('<div class="imageSwitchBtnArea"/>').appendTo(A).css("position", "absolute").css("zIndex", 3).css("display", v)
                }
                b("<div />").appendTo(A);
                var h = b('<div class="switchGroup"/>').appendTo(A).css("width", (c.width <= A.width()) ? c.width: "100%").css("position", "relative").height("y,show-y".indexOf(c.animateStyle) != -1 ? g * J: g).css("overflow", "hidden");
                var u = 0;
                var q = "100%";
                if (c.btnType == 0) {
                    c.animateStyle = "x"
                ...
                function(N, Q) {
                    ...
                    var M = b('<a hidefocus="true" style="outline:none;" ' + L + "/>").appendTo(h).css("width", q).css("height", g + "px").attr("href", Q.href ? Q.href: "javascript:;").attr("target", Q.target ? Q.target: "").attr("title", Q.tip ? Q.tip: "").css("cursor", Q.href ? "pointer": "default").css("background-position", c.position).css("background-repeat", c.repeat).css("overflow", "hidden").css("display", "block").css("float", "x,show-x".indexOf(c.animateStyle) != -1 ? "left": "");
                    if (Q.width && Q.width > 0) {
                        M.html("<img src='" + Q.src + "' width='" + Q.width + "' height='" + Q.height + "'>")
                    } else {
                        M.css("background-image", "url(" + Q.src + ")")
                    }
                    if (c.btnType == 1) {
                        var O = b('<a class="imageSwitchBtn" />').appendTo(C).html("<span>" + (N + 1) + "</span>")
                    } else {
                        if (c.btnType == 2) {
                            var O = b('<a class="imageSwitchBtn_dot" />').appendTo(C)
                        }
                    }
                    var K = b('<span class="spanHiddenName"/>').appendTo(s).css("margin-left", 10 + "px").text(Q.name);
                    if (c.btnType != 0) {
                        if (N == e) {
                            if (c.btnType == 1) {
                                O.addClass("imageSwitchBtnSel")
                            } else {
                                O.addClass("imageSwitchBtnSel_dot")
                            }
    ...
    function CloudZoom(jWin, opts) {
        ...
        setTimeout(function() {
            if ($mouseTrap === null) {
                var w = jWin.width();
                jWin.parent().append(format('<div style="width:%0px;height:25px;position:absolute;top:48%;left:%1px;text-align:center;display:none;" class="cloud-zoom-loading" >Loading...</div>', w / 3, (w / 2) - (w / 6))).find(":last").css("opacity", 0.5)
            }
        },
        200);
        ...
        this.controlLoop = function() {
            if (lens) {
                ...
                if (x < 0) {
                    ...
                    if (x > (sImg.parent().outerWidth() - cw)) {
                        x = (sImg.parent().outerWidth() - cw)
                    }
                }
                if (y < 0) {
                    y = 0
                } else {
                    if (y > (sImg.parent().outerHeight() - ch)) {
                        y = (sImg.parent().outerHeight() - ch)
                    }
                }
                lens.css({
                    left: x,
                ...
                destU = (((x) / sImg.parent().outerWidth()) * zoomImage.width) >> 0;
                destV = (((y) / sImg.parent().outerHeight()) * zoomImage.height) >> 0;
        ...
        this.init = function() {
            ...
            var zoomImgWidth = opts.imageWidth;
            var zoomImgHeight = opts.imageHeight;
            $mouseTrap = jWin.parent().append(format("<div class='mousetrap' style='z-index:4;  background:none; position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;'></div>", sImg.parent().outerWidth(), sImg.parent().outerHeight(), 0, 0)).find(":last");
            if (zoomImgHeight <= opts.maxHeight && zoomImgWidth <= opts.maxWidth) {
                return false
            }
            jWin.parent().find("img").bind("mousemove", this,
            function(event) {
                mx = event.pageX;
                my = event.pageY;
                if ($mouseTrap) {
            ...
            jWin.parent().find("img").bind("mouseleave", this,
            function(event) {
            ...
            function(event) {
                ...
                yPos = opts.adjustY;
                var siw = sImg.parent().outerWidth();
                var sih = sImg.parent().outerHeight();
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');background-repeat:no-repeat;z-index:3;"></div>', xPos, yPos, w, h, zoomImage.src)).find(":last");
                ...
                cw = (sImg.parent().outerWidth() / zoomImage.width) * zoomDiv.width();
                ch = (sImg.parent().outerHeight() / zoomImage.height) * zoomDiv.height();
                ...
                if (opts.tint) {
                    ...
                    $tint = jWin.append(format('<div style="display:none;position:absolute; left:0px; top:0px; width:%0px; height:%1px; background-color:%2;" />', sImg.parent().outerWidth(), sImg.parent().outerHeight(), opts.tint)).find(":last");
                ...
                if (opts.softFocus) {
                    lens.css("background", 'url("' + sImg.attr("src") + '")');
                    softFocus = jWin.append(format('<div style="position:absolute;display:none;top:2px; left:2px; width:%0px; height:%1px;" />', sImg.parent().outerWidth() - 2, sImg.parent().outerHeight() - 2, opts.tint)).find(":last");
        ...
        this.each(function() {
            ...
            if ($(this).is(".cloud-zoom")) {
                ...
                if ($(this).parent().attr("id") != "wrap") {
                    $(this).wrap('<div id="wrap" style="top:0px;z-index:5;position:relative;overflow:hidden;"></div>')
                }
                opts = $.extend({},
    ...
    function clickAndMouseoverEvent(event) {
        event.data.parents("li").parent().children("li").removeClass("g_imgFrameHover");
        if (!event.data.parents("li").hasClass("g_imgFrameHover")) {
            event.data.parents("li").addClass("g_imgFrameHover")
        }
        var data = event.data.data("relOpts");
        $("#" + data.useZoom).data("zoom").destroy();
        $("#" + data.useZoom).attr("href", event.data.attr("href"));
        zoomImgWidth = event.data.data("relOpts").imageWidth;
        zoomImgHeight = event.data.data("relOpts").imageHeight;
